...
<div class="row mt-5 ">
    <div class="col-md-3">
        <a class="btn btn-outline-primary mb-2" href="{{ $client ? $client->path() : route('orders.index') }}">
            ...
            <x-slot name="body">
                ...
                <div class="mb-3 d-flex flex-row justify-content-between">
                    <button data-toggle="modal" data-target="#notesModal" class="btn btn-outline-primary">
                        <i class="fas fa-sticky-note fa-fw mr-1"></i>Anotações
                        ({{ $order->notes->WhereNull('is_reminder')->count() }})
                    </button>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h5 @class([ 'font-weight-bold' , 'text-success'=> $order->status->id == 8,
                ...
                <div class="d-flex justify-content-around mt-4">
                    ...
                    <div>
                        ...
                        <h5 @class([ 'text-danger'=> $order->getTotalOwing() > 0,
