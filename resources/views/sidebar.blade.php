    ...
    <div class="accordion accordion-sidebar" id="accordionSidebar">
        <ul class="list-group-flush list-unstyled">
            ...
            <li class="position-relative">
                <a class="{{ Request::is(['despesas*', 'fluxo-de-caixa*']) ?: 'collapsed' }}" data-toggle="collapse"
                    href="#collapseFinancial" aria-expanded="false" aria-controls="collapseFinancial">
                ...
                <div id="collapseFinancial"
                    class="collapse {{ Request::is(['despesas*', 'fluxo-de-caixa*']) ? 'show' : '' }}"
            ...
            <li class="position-relative">
              ...
              'tipos-de-roupas*'
                ...
                <div id="collapseManagement" class="collapse {{ Request::is([
              'usuarios*',
              'gerenciamento*',
              'backup*',
              'tipos-de-roupas*'
            ]) ? 'show' : '' }}" data-parent="#accordionSidebar">
                    <ul class="list-group-flush list-unstyled">
