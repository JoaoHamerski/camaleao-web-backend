...
@section('content')
  <div class="container">
    <div class="col col-md-6 col-md-4 mx-auto mt-5">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('auth.login') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" name="email" autocomplete="email">
