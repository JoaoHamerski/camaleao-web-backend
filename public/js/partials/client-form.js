...
(0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name=phone]'), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleavePhone);
...
$('#btnEditClient').click(function (e) {
  ...
  var $btn = $(this);
  (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn, true);
  axios.patch((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)(), {
    name: $('[name=name]').val(),
    phone: $('[name=phone]').val(),
    city: $('[name=city]').val()
  }).then(function (response) {
...
$('#btnDeleteClient').click(function (e) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      axios["delete"]((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)()).then(function (response) {
        window.location = response.data.redirect;
      });
    }
  });
