...
$('a[data-attach]').on('click', function (e) {
  ...
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/file-view', {
    option: option
...
$('#btnDeleteOrder').on('click', function (e) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      axios["delete"]((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/deletar').then(function (response) {
...
$('#btnAddNote').on('click', function (e) {
  ...
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/new-note', {
...
$(document).on('click', '.btn-delete-item', function (e) {
  ...
  axios["delete"]((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/delete-note/' + id).then(function (response) {
    $itemWrapper.remove();
    $('button[data-target="#notesModal"]').html('Anotações (' + response.data.countNotes + ')');
  });
});
$('#btnAddPayment').on('click', function (e) {
  ...
  (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn, true);
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/new-payment', formData).then(function (response) {
    window.location = response.data.redirect;
  })["catch"](function (error) {
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.dispatchErrorMessages)(error.response.data.errors);
  }).then(function () {
