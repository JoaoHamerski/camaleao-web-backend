...
(0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name=all_date]'), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleaveDate);
/*
...
function getTotalValue() {
  ...
  $('[name*=value]').each(function () {
    total += +(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.sanitizeMoney)($(this).val());
  });
  return total;
}
/*
...
var observer = new MutationObserver(function () {
  (0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name*=value]').last(), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleaveValueBRL);
  (0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name*=date]').last(), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleaveDate);
...
$('#btnNewExpense').on('click', function (e) {
  e.preventDefault();
  var $btn = $(this);
  (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($(this), true);
  var index = $('.form-inline-wrapper').last().attr('data-index');
  index = isNaN(index) ? 0 : index;
  axios.get((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/get-inline-form', {
    params: {
      index: +index + 1
    }
...
$('#formExpenses button[type="submit"]').on('click', function (e) {
  ...
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)(), formData).then(function (response) {
