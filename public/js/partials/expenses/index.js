...
(0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name=value]'), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleaveValueBRL);
(0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name*=date]'), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleaveDate);
(0,_cleave__WEBPACK_IMPORTED_MODULE_0__.applyCleave)($('[name*=dia]'), _cleave__WEBPACK_IMPORTED_MODULE_0__.cleaveDate);
/*
...
$('#btnAddExpenseType').on('click', function (e) {
  ...
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/tipo-de-despesa', {
...
$(document).on('click', '.btn-delete-expense-type', function (e) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      axios["delete"]((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/tipo-de-despesa/' + id + '/deletar').then(function () {
        $('[data-id=' + id + ']').remove();
...
$(document).on('click', '.btn-update-expense-type', function (e) {
  ...
  var id = $(this).parents('[data-id]').attr('data-id');
  (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn, true);
  axios.patch((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/tipo-de-despesa/' + id, {
...
$('.btn-delete').on('click', function (e) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn, true);
      axios["delete"]((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/' + id + '/deletar').then(function (response) {
...
$('#btnCreateUniqueExpense').on('click', function (e) {
  ...
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/cadastro', formData).then(function (response) {
    window.location = response.data.redirect;
  })["catch"](function (error) {
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.dispatchErrorMessages)(error.response.data.errors, '#createFormModal');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn, false);
  });
});
/*
...
$(document).on('click', '#btnUpdateExpense', function (e) {
  ...
  (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn, true);
  var formData = new FormData($(this).parents('form').get(0));
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/' + id, formData).then(function (response) {
    window.location = response.data.redirect;
  })["catch"](function (error) {
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.dispatchErrorMessages)(error.response.data.errors, '#editFormModal');
    (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.loadingBtn)($btn);
  });
});
/*
...
$('.btn-edit').on('click', function () {
  var id = $(this).parents('[data-id]').attr('data-id');
  axios.get((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/' + id + '/get-edit-form').then(function (response) {
...
$(document).on('click', '#deleteReceipt', function (e) {
  ...
  var id = $(this).parents('[data-id]').attr('data-id');
  var $btn = $(this);
  axios["delete"]((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/' + id + '/delete-receipt').then(function () {
...
$('.btn-view-receipt').on('click', function (e) {
  e.preventDefault();
  var id = $(this).parents('[data-id]').attr('data-id');
  axios.get((0,_helpers__WEBPACK_IMPORTED_MODULE_1__.getLocationURL)() + '/' + id + '/get-view-receipt').then(function (response) {
