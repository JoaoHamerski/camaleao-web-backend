...
$('[data-target="#changePaymentModal"]').on('click', function (e) {
  ...
  axios.get((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getLocationURL)() + '/pagamento/' + id + '/get-change-payment-view').then(function (response) {
...
$(document).on('click', '#btnChangePayment', function (e) {
  ...
  axios.post((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getLocationURL)() + '/pagamento/' + id, formData).then(function (response) {
